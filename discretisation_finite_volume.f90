...
!!!!!!!!!!!!!!!!!!
	  ...
	  call VTSWriter(time,k,m+1,n+1,x,y,c,'int') ! On appelle la subroutine tous les 10 pas de temps le fichier vtscela est expliqué dans la subroutine VTSWriter
